...
public class KleinSmartRefreshLayout extends SmartRefreshLayout {
    public static final int TYPE_FRESH = 0;
    public static final int TYPE_LOAD_MORE = 1;

    public KleinSmartRefreshLayout(Context context) {
        this(context, null);
    }

    public KleinSmartRefreshLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
